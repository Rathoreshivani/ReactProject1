                        ...
                        <div>
                            <div className="container-fluid">
                                <div className="row">
                                    ...
                                    <div className="col-lg-12">
                                        Enter Name: <input type="text" className="demo" name="name" value={this.state.name} onChange={this.login} required />
                                    </div>
                                    <div className="col-lg-12">
                                        Enter Password: <input type="password" className="demo1" name="password" value={this.state.password} onChange={this.login} required />
                                    </div>
                                    <div className="col-lg-12">
